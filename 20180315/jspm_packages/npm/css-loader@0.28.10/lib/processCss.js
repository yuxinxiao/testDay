...
(function(process) {
  ...
  module.exports = function processCss(inputSource, inputMap, options, callback) {
    ...
    var pipeline = postcss([modulesValues, localByDefault({
      mode: options.mode,
    ...
    }), extractImports(), modulesScope({generateScopedName: function generateScopedName(exportName) {
    ...
    pipeline.process(inputSource, {
      ...
      if (err.name === 'CssSyntaxError') {
        var wrappedError = new CSSLoaderError('Syntax Error', err.reason, err.line != null && err.column != null ? {
          line: err.line,
          column: err.column
        } : null, err.input.source);
