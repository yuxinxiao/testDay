...
'use strict';
(function(m, p) {
  "object" === typeof exports && "undefined" !== typeof module ? module.exports = p(require('react'), require('../index')) : "function" === typeof define && define.amd ? define(["react", "react-dom"], p) : m.ReactTestUtils = p(m.React, m.ReactDOM);
})(this, function(m, p) {
  function k(a) {
  ...
  function M(a) {
    return function(b, c) {
      m.isValidElement(b) ? k("228") : void 0;
      e.isCompositeComponent(b) ? k("229") : void 0;
      var d = F.eventNameDispatchConfigs[a],
          g = new E;
      g.target = b;
      g.type = a.toLowerCase();
      var n = N.getInstanceFromNode(b),
          h = new t(d, n, g, b);
      h.persist();
      u(h, c);
      d.phasedRegistrationNames ? G.accumulateTwoPhaseDispatches(h) : G.accumulateDirectDispatches(h);
      p.unstable_batchedUpdates(function() {
        O.enqueueStateRestore(b);
        q.enqueueEvents(h);
        q.processEventQueue(!0);
      });
    };
  }
  function z() {
    e.Simulate = {};
    for (var a in F.eventNameDispatchConfigs)
      e.Simulate[a] = M(a);
  }
  function P(a) {
    return function(b, c) {
      var d = new E(a);
      u(d, c);
      e.isDOMComponent(b) ? e.simulateNativeEventOnDOMComponent(a, b, d) : b.tagName && e.simulateNativeEventOnNode(a, b, d);
    };
  }
  var u = m.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.assign,
      d = function() {};
  d.thatReturns = v;
  d.thatReturnsFalse = v(!1);
  d.thatReturnsTrue = v(!0);
  d.thatReturnsNull = v(null);
  ...
  var n = d,
      H = "dispatchConfig _targetInst nativeEvent isDefaultPrevented isPropagationStopped _dispatchListeners _dispatchInstances".split(" ");
  d = {
    type: null,
    target: null,
  ...
  t.augmentClass = function(a, b) {
    ...
    a.Interface = u({}, this.Interface, b);
  ...
  var h = {
    ...
    transitionend: w("Transition", "TransitionEnd")
      ...
      y = {},
      D = {};
  d && (D = document.createElement("div").style, "AnimationEvent" in window || (delete h.animationend.animation, delete h.animationiteration.animation, delete h.animationstart.animation), "TransitionEvent" in window || delete h.transitionend.transition);
  d = {
    topAbort: "abort",
  ...
  var Q = p.findDOMNode,
      ...
      e = {
        ...
        findAllInRenderedTree: function(a, b) {
          if (!a)
            return [];
          e.isCompositeComponent(a) ? void 0 : k("10");
          return L(a._reactInternalFiber, b);
        },
        ...
        findRenderedDOMComponentWithClass: function(a, b) {
          a = e.scryRenderedDOMComponentsWithClass(a, b);
          if (1 !== a.length)
        ...
        findRenderedDOMComponentWithTag: function(a, b) {
          a = e.scryRenderedDOMComponentsWithTag(a, b);
          if (1 !== a.length)
        ...
        findRenderedComponentWithType: function(a, b) {
          a = e.scryRenderedComponentsWithType(a, b);
          if (1 !== a.length)
      ...
      S = q.injection.injectEventPluginOrder;
  q.injection.injectEventPluginOrder = function() {
    S.apply(this, arguments);
    z();
  };
  var T = q.injection.injectEventPluginsByName;
  q.injection.injectEventPluginsByName = function() {
  ...
  Object.keys(d).forEach(function(a) {
    ...
    e.SimulateNative[b] = P(a);
  });
  d = (d = Object.freeze({default: e})) && e || d;
