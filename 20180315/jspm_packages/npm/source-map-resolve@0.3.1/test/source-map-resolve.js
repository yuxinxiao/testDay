...
var sourceMapResolve = require('../lib/source-map-resolve-node');
...
function testResolve(method, sync) {
  return function(t) {
    ...
    method(code.fileRelative, codeUrl, readMap(map.sourceRoot), options, function(error, result) {
      t.error(error);
      t.deepEqual(result.sourcesResolved, ["http://example.com/a/b/c/foo.js", "http://example.com/a/b/c/lib/bar.js", "http://example.com/a/b/vendor/dom.js", "http://example.com/version.js", "http://foo.org/baz.js"], "sourceRoot");
